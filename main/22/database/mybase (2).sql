...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2021 at 12:20 PM
...
INSERT INTO `client_data` (`c_id`, `c_name`, `cc_name`, `c_email`, `c_psw`, `c_number`, `c_add`, `c_date_time`, `c_status`) VALUES
(1, 'M Arsalan', 'Crudtech', 'arsalan@gmail.com', '12345', '12345', 'check data', '2021-02-22 09:33:09', 1);
...
CREATE TABLE `orders` (
  ...
  `o_ship` varchar(200) NOT NULL,
  `o_data` varchar(1000) NOT NULL,
...
INSERT INTO `orders` (`o_id`, `o_user`, `o_ship`, `o_data`, `o_date_time`, `o_status`) VALUES
(1, 1, 'lab 209 me', '{\"5\":{\"qty\":2,\"price\":4998},\"4\":{\"qty\":2,\"price\":3998}}', '2021-02-22 10:44:19', 1),
(2, 1, '', '{\"3\":{\"qty\":3,\"price\":3300},\"4\":{\"qty\":1,\"price\":\"1999\"},\"2\":{\"qty\":1,\"price\":\"1200\"}}', '2021-02-22 10:46:25', 1);
...
(2, 'Watch ', 'Black color watch', 5500, 1200, 64, 3, '[\"c678cad4831ee328333cf66374e3073d.jpg\"]', 1, '2021-02-17 09:35:14', 2),
...
(4, 'Silver watch', 'Silver color eatch', 2000, 1999, 9, 3, '[\"e73beeebf0b0c1f04bf252ac82b430c1.jpg\"]', 1, '2021-02-17 09:36:30', 2),
(5, 'Blackshoes', 'Black colr shoes\r\n', 2500, 2499, 8, 2, '[\"41Leu3gBUFL.jpg\"]', 1, '2021-02-17 09:37:50', 2),
